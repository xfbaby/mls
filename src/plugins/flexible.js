! function(a, b) {
    function c() { var b = f.getBoundingClientRect().width;
        ...
        f.style.fontSize = c*1.3 + "px", k.rem = a.rem = c } var d, e = a.document,
        f = e.documentElement,
        g = e.querySelector('meta[name="viewport"]'),
        h = e.querySelector('meta[name="flexible"]'),
        i = 0,
        j = 0,
        k = b.flexible || (b.flexible = {}); if (g) { var l = g.getAttribute("content").match(/initial\-scale=([\d\.]+)/);
        ...
        else { var r = e.createElement("div");
